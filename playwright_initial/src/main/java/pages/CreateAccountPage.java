...
public class CreateAccountPage {
    ...
    public void createAccount(){
        createAccountPage.locator(FIRST_NAME).fill("FName");
        createAccountPage.locator(LAST_NAME).fill("LName");
        createAccountPage.locator(EMAIL).fill("mail@mail.com");
        createAccountPage.locator(PASSWORD).fill("qweqwe123!");
        createAccountPage.locator(CONFIRM_PASSWORD).fill("qweqwe123!");
        ...
        createAccountPage.locator(PHONE).fill("1231231233");
        createAccountPage.locator(RECOVERY_PHONE_CHECKBOX).check();

        assertThat(createAccountPage.locator(SUBMIT)).isEnabled();
    }
}
